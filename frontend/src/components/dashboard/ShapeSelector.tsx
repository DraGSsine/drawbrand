...
const ShapeSelector: React.FC<ShapeSelectorProps> = ({
  ...
  return (
    <div className="relative flex flex-col gap-3 p-3 bg-white w-[280px]">
      {/* Fill mode selector */}
      <div className="rounded-xs bg-gray-100 p-1 w-full flex gap-1">
        <button
          className={`${
            fillMode === 'regular'
              ? 'bg-blue-500 text-white'
              : 'text-gray-800 hover:bg-gray-200'
          } flex items-center justify-center flex-1 font-medium text-sm px-2 py-1 rounded`}
      ...
      <div className="grid grid-cols-9 gap-3">
        {/* Pentagon */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.PENTAGON)}>
        ...
        {/* Rectangle */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.RECTANGLE)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              d="M2 2V22H22V2H2Z" 
              fill={isSolid ? "#020617" : "none"} 
        ...
        {/* Diamond */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.DIAMOND)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Parallelogram */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.PARALLELOGRAM)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Trapezoid */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.TRAPEZOID)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Frame */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.FRAME)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Hexagon */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.HEXAGON)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Octagon */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.OCTAGON)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* House */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.HOUSE)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Polygon */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.POLYGON)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Triangle */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.TRIANGLE)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Right Triangle */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.RIGHT_TRIANGLE)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              d="M2 2L22 22H2V2Z" 
              fill={isSolid ? "#020617" : "none"} 
        ...
        {/* Double Triangle */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.DOUBLE_TRIANGLE)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Arrow Tip */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.ARROW_TIP)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Circle */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.CIRCLE)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Half Circle */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.HALF_CIRCLE)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Pill */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.PILL)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Rounded Rectangle */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.ROUNDED_RECT)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Ring */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.RING)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Semi Circle */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.SEMI_CIRCLE)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Star */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.STAR)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Heart */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.HEART)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
        ...
        {/* Star 4 */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.STAR_4)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Star 5 */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.STAR_5)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Arrow Right */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.ARROW_RIGHT)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Arrow Bidirectional */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.ARROW_BIDIRECTIONAL)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Arrow Corner */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.ARROW_CORNER)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Arrow Block */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.ARROW_BLOCK)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Arrow Cross */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.ARROW_UP_RIGHT)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Arrow Left */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.ARROW_LEFT)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Arrow Double */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.ARROW_DOUBLE)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Speech Bubble */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.SPEECH_BUBBLE)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Thought Bubble */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.THOUGHT_BUBBLE)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        {/* Cloud */}
        <button className="w-6 h-6" onClick={() => onSelectShape(ShapeType.CLOUD)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path 
